...
document.getElementById("birthday_button").addEventListener("click", function(){
  ...
  braze.getUser().setDateOfBirth(birthday)
...
//CUSTOM ATTRIBUTES
    ...
    document.getElementById("attribute_button").addEventListener("click", function(){
        ...
        var attributeValue = document.getElementById("attribute_value").value;
        if(attributeName && attributeValue) {
            braze.getUser().setCustomUserAttribute(attributeName, attributeValue);
            alert("Custom attribute '" + attributeName + "' was set to " + "'" + attributeValue + "'");
        } else {
            alert("Please enter both an attribute name and a value.");
        }
    });
